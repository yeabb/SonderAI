    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_tweet', models.ForeignKey(blank=True, help_text='Reference to the original tweet if this is a retweet.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='retweets_set', to='graphs.tweetnode')),
                ('parent_node', models.ForeignKey(blank=True, help_text='The parent node of the thread if this is part of a thread.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_tweets', to='graphs.tweetnode')),
                ('replies', models.ManyToManyField(blank=True, help_text='Replies to this tweet.', related_name='parent_tweets', to='graphs.tweetnode')),
